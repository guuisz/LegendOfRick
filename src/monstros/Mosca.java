...
public class Mosca extends Monstro{
	
	public Mosca(String nome, int hp, int mana, int str, int level) {
		super(nome, hp, mana, str, level);
		// TODO Auto-generated constructor stub
	}

	public int bater(Humano personagem) {
		System.out.println("Mosca bateu");
	...
	public void dropaItem(Humano jogador) {
		...
		if(dropNum == 0) {
			...
			System.out.println("Voce ganhou uma asa de mosca!");
			Item asaDeMosca = new Item();
			jogador.getItens().add(asaDeMosca);
			...
			System.out.println("Voce ganhou um equipamento Mosca!");
			Equipamento equipamento = new Equipamento();
			jogador.getArsenalDeEquipamento().add(equipamento);
			
			System.out.println("Voce ganhou a espada Mosca!");
			Arma arma = new Arma();
			...
			System.out.println("Voce ganhou a insignia Mosca!");
	...
	public String toString() {
		return "Mosca [nome=" + nome + ", hp=" + hp + ", mana=" + mana + ", str=" + str + "]";
	}
